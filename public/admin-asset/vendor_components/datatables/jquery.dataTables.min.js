...
!function (n) {
    ...
    function Yt(t, e, n) {
        var a = t._iDisplayStart, r = t._iDisplayLength, o = t.fnRecordsDisplay(),
            o = (0 === o || -1 === r ? a = 0 : "number" == typeof e ? o < (a = e * r) && (a = 0) : "first" == e ? a = 0 : "previous" == e ? (a = 0 <= r ? a - r : 0) < 0 && (a = 0) : "next" == e ? a + r < o && (a += r) : "last" == e ? a = Math.floor((o - 1) / r) * r : W(t, 0, "Unknown paging action: " + e, 10), t._iDisplayStart !== a);
    ...
    var Ie = [], o = Array.prototype, B = function (t, e) {
        ...
        oLanguage: {
            ...
            sInfo: "Showing _START_ to _END_ of _TOTAL_ ورودی",
            sInfoEmpty: "نمای 0 تا 0 از 0 داده",
