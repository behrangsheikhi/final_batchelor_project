            ...
            <div class="row mb-2">
                <div class="col-12">
                    <ol class="breadcrumb float-right mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.comment.index') }}">نظرات</a>
                        </li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <section class="comment-reply-section" id="comment-reply-section">
                            @include('admin.comment.market_comment_partial',['comment' => $comment])
                            @yield('comment')
                        </section>
                    </div>
                </div>
...
<script type="text/javascript">
    function addComment(event) {
        ...
        let url = "{{ route('admin.comment.reply-to-comment',$comment->id ?? "") }}";
        $.ajax({
            url: url,
            data: formData,
            dataType: "json",
