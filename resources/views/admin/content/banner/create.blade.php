...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                        در این قسمت می توانید اطلاعات بنر مورد نظر را ایجاد و ذخیره کنید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.content.banner.store') }} "
                  id="form"
                  method="post"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <section class="col-12 mb-4">
                            <div class="form-group">
                                <label for="position" class="text-sm text-muted">مکان قرارگیری</label>
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <textarea cols="60" rows="4" class="form-control form-control-sm"
                                          ...
                                          placeholder="توضیحات بنر را اینجا بنویسید ...">{{ old('description') }}</textarea>
                            </div>
                            @error('description')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
                                <strong>
