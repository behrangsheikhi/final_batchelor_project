...
@section('head-tag')
    <title>محتوا | نظرات پست ها</title>
                            ...
                            <table id="example" class="display table table-striped table-bordered table-responsive-md table-hover" style="width:100%">
                                ...
                                @foreach($comments as $comment)
                                    <tr role="row" class="odd">
                                        ...
                                        @if($comment->commentable_type == \App\Constants\CommentTypeValue::CONTENT_COMMENT)
                                            <td title="مشاهده پست">
                                        ...
                                        <td class="d-flex flex-row justify-content-end">
                                            <a href="{{ route('admin.content.comment.fetch-comment', $comment->id) }}"
