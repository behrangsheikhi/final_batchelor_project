...
@section('head-tag')
    <title>محتوا | ویرایش سوال متداول</title>
@endsection
...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                        شما در حال ویرایش اطلاعات مربوط به سوال <span class="text-success font-weight-bold">{{ $faq->question }}</span> هستید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.content.faq.update',$faq->id) }} "
                  id="form"
                  method="post"
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control form-control-sm">
                                    ...
                                    <option value="0" @if(!old('status',$faq->status)) selected @endif>غیر فعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
                ...
                <section class="col-12 mb-4">
                    <div class="form-group">
                        ...
                        <textarea cols="60"
                                  ...
                                  name="answer" id="answer">{{ old('answer',$faq->answer) }}</textarea>
                    </div>
                    @error('answer')
                    <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
                                <strong>
