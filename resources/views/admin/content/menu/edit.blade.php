        ...
        <div class="container-fluid">
            ...
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                        شما در حال ویرایش اطلاعات منوی <span class="text-success font-weight-bold">{{ $menu->name }}</span> هستید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <select name="parent_id" id="parent_id" class="form-control form-group-sm">
                                ...
                                @foreach($items as $item)
                                    <option value="{{ $item->id }}"
                                            @if(old('parent_id', $menu->parent_id) == $item->id) selected @endif>
                                        {{ $item->name }}
                                    </option>
                                @endforeach
                            </select>
