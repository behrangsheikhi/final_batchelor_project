        ...
        <div class="container-fluid">
            ...
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                       شما در حال ویرایش اطلاعات مربوط به صفحه با عنوان <span class="text-success font-weight-bold">{{ $page->title }}</span> هستید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                <label for="title" class="text-sm text-muted">عنوان صفحه</label>
                                <input type="text"
                                       name="title"
                                       class="form-control"
                                       id="title"
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control form-control-sm">
                                    ...
                                    <option value="0" @if(!old('status',$page->status)) selected @endif>غیر فعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
