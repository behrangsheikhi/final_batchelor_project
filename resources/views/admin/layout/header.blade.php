<header class="main-header">
    ...
    <a href="#" class="logo">
        <!-- mini logo -->
        <div class="logo-mini d-flex justify-content-center align-items-center" style="height: 50px;">
            <h1 style="font-family: 'mj_yalda'; color: #FFFFFF" class="font-weight-bold text-light text-center m-0">
                راسته
                فرش</h1>{{--            <span class="light-logo"><img src="{{ asset('admin-asset/images/logo-light.png') }}" alt="logo"></span>--}}
            ...
            <ul class="nav navbar-nav d-flex justify-content-around">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('admin-asset/images/avatar/7.jpg') }}" class="user-image rounded-circle"
                             alt="User Image">
                    </a>
                    <ul class="dropdown-menu animated flipInY">
                        ...
                        <li class="user-header bg-img"
                            style="background-image: url({{ asset('admin-asset/images/user-info.jpg') }})"
                            data-overlay="3">
                            <div class="flexbox align-self-center">
                                <img src="{{ asset('admin-asset/images/avatar/7.jpg') }}"
                                ...
                                <span class="user-name align-self-center">
                                    <span>
                                        ...
                                        @endauth
                                        @guest()
                                            <a href="{{ route('admin-auth-form') }}" class="btn btn-xs btn-primary">ورود به حساب کاربری</a>
                                        @endguest
                                    </span>
                        ...
                        <li class="user-body">
                            ...
                            {{--                            <div class="dropdown-divider"></div>--}}
                            <a class="dropdown-item" href="{{ route('auth.logout') }}"><i class="fa fa-power-off"></i>
                                خروج</a>
                            <div class="dropdown-divider"></div>
                        </li>
                    </ul>
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle comments-dropdown-toggle" id="comments-dropdown-toggle"
                       data-toggle="dropdown">
                        <i class="fa fa-comments"></i>
                        @if($unseen_comments->count() > 0)
                            <span id="comment-badge"
                                  class="badge badge-danger badge-sm badge-pill">{{ $unseen_comments->count() }}</span>
                        @endif
                    ...
                    <ul class="dropdown-menu animated fadeInDown">
                        ...
                        <li class="header">
                            <div class="bg-img text-white p-20"
                                ...
                                <div class="flexbox">
                                    <div>
                                        <h4 class="mb-0 mt-0">{{ $unseen_comments->count() !== 0 ? $unseen_comments->count() : 'صفر' }}
                                            نظر جدید </h4>
                                ...
                                @foreach($unseen_comments as $comment)
                                    <li><!-- start message -->
                                        <a href="{{ route('admin.comment.show',$comment->id) }}">
                                            <div class="pull-left">
                                                <img src="{{ asset('admin-asset/images/user2-160x160.jpg') }}"
                                            ...
                                            <div class="mail-contnet">
                                                <h4>
                                                    ...
                                                    <small><i
                                                            class="fa fa-clock-o"></i> {{ persianDate($comment->created_at) }}
                                                    </small>
                                                </h4>
                        ...
                        <li class="footer">
                            <a href="{{ route('admin.comment.index') }}" class="text-white bg-info">مشاهده همه نظرات</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <a href="#" class="dropdown-toggle" id="dropdown-toggle" data-toggle="dropdown">
                        ...
                        @if($notifications->count() > 0)
                            <span id="notification-badge"
                                  class="badge badge-danger badge-sm badge-pill">{{ $notifications->count() }}</span>
                        @endif
                    ...
                    <ul class="dropdown-menu animated fadeInDown">
                        <li class="header">
                            <div class="bg-img text-white p-20"
                                ...
                                <div class="flexbox">
                                    <div>
                                        <h4 class="mb-0 mt-0">{{ $notifications->count() !== 0 ? $notifications->count() : 'صفر' }}
                                            اطلاعیه جدید </h4>
                                    </div>
                                    <div class="font-size-40">
                        ...
                        <li>
                            ...
                            <ul class="menu sm-scrol">
                                @foreach($notifications as $notification)
                                    <li><!-- start message -->
                                        <a href="{{ route('admin.user.app.index') }}" title="مشاهده"
                                           class="d-flex flex-col flex-wrap">
                                            <div class="mail-contnet">
                                                <span class="card">
                                                    <span class="detail">{{ $notification['data']['message'] }}</span>
                                                </span>
                                            </div>
                                            <span class="text-left"><small
                                                    class="text-muted">{{ persianDateTime($notification->created_at) }}</small></span>
                                        </a>
                                    </li>
                                @endforeach
                        ...
                        <li class="footer">
                            <a href="{{ route('admin.notification.index') }}" class="text-white bg-info">مشاهده همه
                                اعلانات</a></li>
                    </ul>
                </li>
                <!-- Notifications -->
