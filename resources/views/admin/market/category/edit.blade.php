...
<section class="content">
    <div class="container-fluid">
        <form action="{{ route('admin.market.category.update',$category->id) }} " id="form" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row">
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="tags" class="form-control" id="tags" value="{{ old('tags',$category->tags) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" name="image" class="custom-file-input form-control form-control-sm" id="image">
                                    <label style="border-top-left-radius: 0;border-bottom-left-radius: 0" class="custom-file-label font-weight-bold text-right" for="image">جهت انتخاب تصویر اینجا کلیک کنید</label>
                                </div>
                ...
                <section class="col-12">
                    <div class="form-group">
                        ...
                        <textarea cols="60" rows="4" class="form-control form-control-sm" name="description" id="description">{{ old('description',$category->description) }}</textarea>
                    </div>
                    @error('description')
                    <span class="alert_required text-danger" role="alert">
                        <strong>
