            ...
            <div class="card-body" style="border: 1px solid #cdcdcd;border-radius: 5px;">
                ...
                <div class="row">
                    <section class="col-4">
                        ...
                        <span class="font-weight-bold">{{ persianDateTime($payment->created_at) }}</span>
                    </section>
                    <section class="col-4">
                        <label for="">نوع پرداخت:</label>
                        <span class="font-weight-bold">
                            @if($payment->paymentable_type === \App\Constants\PaymentableTypeValue::OFFLINE)
                                پرداخت کارت به کارت
                            @elseif($payment->paymentable_type === \App\Constants\PaymentableTypeValue::CASH)
                                پرداخت در محل
                            @elseif($payment->paymentable_type === \App\Constants\PaymentableTypeValue::ONLINE)
                               پرداخت آنلاین
