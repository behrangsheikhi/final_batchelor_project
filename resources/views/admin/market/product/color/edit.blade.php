...
@section('head-tag')
    <title>فروشگاه | کالا | ویرایش رنگ</title>
...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                       شما در حال ویرایش اطلاعات مربوط به رنگ <span class="text-success font-weight-bold">{{ $color->color_name }}</span>
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.market.product.color.update',['product' => $product->id,'color' => $color->id]) }} "
                  id="form"
                  method="post"
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control form-group-sm">
                                    ...
                                    <option value="0" @if(!old('status',$color->status)) selected @endif>غیرفعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
