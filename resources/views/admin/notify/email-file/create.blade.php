...
@section('head-tag')
    <title>اطلاعیه ها | اطلاعیه ایمیلی | ایجاد فایل جدید</title>
@endsection
...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12">
                    <ol class="breadcrumb float-sm-left" style="font-size: 0.8rem">
                        ...
                        <li class="breadcrumb-item active">ایجاد فایل ایمیل</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                        در این قسمت می توانید برای ایمیل با عنوان <span class="text-success font-weight-bold">{{ $email->subject }}</span> فایل الصاقی ایجاد کنید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.notify.email-file.store',$email->id) }}"
                  method="post"
                    ...
                    <section class="col-12 mb-4">
                        <div class="form-group">
                            ...
                            <select name="store_to" id="store_to" class="form-control form-group-sm">
                                <option value="1" @if(old('store_to') == 1) selected @endif>خصوصی</option>
                                <option value="0" @if(!old('store_to')) selected @endif>عمومی</option>
                            </select>
                        </div>
                        @error('store_to')
                        <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
