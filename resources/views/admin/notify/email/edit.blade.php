...
@section('head-tag')
    <title>اطلاعیه ها | اطلاعیه ایمیلی | ویرایش ایمیل </title>
...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                        شما در حال ویرایش اطلاعات ایمیل با عنوان <span class="text-success font-weight-bold">{{ $email->subject }}</span> هستید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.notify.email.update',$email->id) }} "
                  id="form"
                  method="post"
                        ...
                        <section class="col-12 mb-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control form-control-sm">
                                    ...
                                    <option value="0" @if(!old('status',$email->status)) selected @endif>غیر فعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
                ...
                <section class="col-12 mb-4">
                    <div class="form-group">
                        <label for="body" class="text-sm
                                    text-muted">متن اطلاعیه ایمیل</label>

                        <textarea cols="60"
                                  rows="4"
                                  class="form-control form-control-sm"
                                  name="body" id="body">{{ old('body',$email->body) }}</textarea>
                    </div>
                    @error('body')
                    <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
                                <strong>
