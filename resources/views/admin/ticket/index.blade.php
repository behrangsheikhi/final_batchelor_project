                                    ...
                                    <tr style="font-size: 0.8rem;">
                                        ...
                                        <td class="text-{{ $ticket->file ? 'success' : 'danger' }} font-weight-bold">
                                            @if($ticket->file()->count() > 0)
                                                <a target="_blank" href="{{ asset($ticket->file->file_path) }}" title="دانود فایل ضمیمه"
                                                   class="btn btn-sm btn-success text-white"><i class="mdi mdi-download"></i></a>
                                            @else
                                                ندارد
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            @if ($ticket->children->isNotEmpty())
                                                <p class="text-success fw-bold">پاسخ داده شده</p>
                                            @else
                                                <p class="text-danger fw-bold">در انتظار پاسخ</p>
                                            @endif
                                        </td>
