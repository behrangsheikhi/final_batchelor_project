                                    ...
                                    <li>
                                        ...
                                        <span data-toggle="tooltip" title="" class="badge badge-pill badge-info"
                                            ...
                                            @php
                                                ...
                                                $latestRepliesCount = $ticket->children()->where('created_at', '>=', $twentyFourHoursAgo)->count();
                                            @endphp
                                            {{ $latestRepliesCount }}
                                        </span>
                                    </li>
                                        ...
                                        <div class="direct-chat-msg mb-30">
                                            ...
                                            <div class="direct-chat-text">
                                                ...
                                                <p class="direct-chat-timestamp">
                                                    <time datetime="2018">{{ persianDateTime($ticket->created_at) }}</time>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        @if($ticket->children)
                                            @foreach($ticket->children as $reply)
                                                <div class="direct-chat-msg right mb-30">
                                                    ...
                                                    <div class="clearfix mb-15">
                                                        <span class="direct-chat-name pull-right">{{ $reply->admin->user->fullname ?? 'ادمین' }}</span>
                                                    </div>
                                                    <div class="direct-chat-text">
