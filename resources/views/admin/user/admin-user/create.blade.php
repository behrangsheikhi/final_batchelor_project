...
@section('head-tag')
    <title>کاربران | ایجاد مدیر</title>
@endsection
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">ایجاد مدیر</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                      در این قسمت می توانید کاربران ادمین سایت خود را مشاهده و یا مدیریت کنید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
...
{{--                </ul>--}}
{{--            @endif--}}
            <form action="{{ route('admin.user.admin-user.store') }} "
                  id="form"
                  method="post"
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       class="form-control"
                                       id="mobile"
                                       placeholder="موبایل مدیر را وارد کنید..."
                                       value="{{ old('mobile') }}">
                            </div>
                            @error('mobile')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
