...
@section('head-tag')
    <title>کاربران | ویرایش مدیر</title>
@endsection
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.user.admin-user.index') }}">مدیران</a></li>
                        <li class="breadcrumb-item active">ویرایش مدیر</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                        شما در حال ویرایش اطلاعات مربوط به ادمین با نام <span class="text-success font-weight-bold">{{ $admin->fullname }}</span> هستید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <form action="{{ route('admin.user.admin-user.update',$admin->id) }} "
                ...
                <div class="card-body">
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="password"
                                       ...
                                       class="form-control"
                                       id="password"
                                       placeholder="کلمه عبور مدیر را وارد کنید..."
                                       value="{{ old('password') }}">
                            </div>
                            @error('password')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="password"
                                       ...
                                       placeholder="کلمه عبور مدیر را تکرار کنید..."
                    ...
                    <div class="row">
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                <label for="status" class="text-sm text-muted">وضعیت مدیر</label>
                                <select name="status" id="status" class="form-control form-control-sm">
                                    <option value="1" @if(old('status',$admin->status) == 1) selected @endif>فعال</option>
                                    <option value="0" @if(!old('status',$admin->status)) selected @endif>غیر فعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
