...
@section('head-tag')
    <title>کاربران | ویرایش مشتری</title>
@endsection
...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                       شما در حال ویرایش اطلاعات مشتری با نام <span class="text-success font-weight-bold">{{ $customer->fullname }}</span> هستید.
                    </small>
                </strong>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.user.app.update',$customer->id) }} "
                  id="form"
                  method="post"
                    ...
                    <div class="row">
                        <section class="col-12 col-md-6 mb-4">
                            ...
                            @if($customer->profile_photo_path)
                                <img src="{{ asset($customer->profile_photo_path) }}"
                                     width="100px"
                                     height="100px"
                        ...
                        <section class="col-12 col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control form-control-sm">
                                    <option value="1" @if(old('status',$customer->status) == 1) selected @endif>فعال</option>
                                    <option value="0" @if(!old('status',$customer->status)) selected @endif>غیر فعال</option>
                                </select>
                            </div>
                            @error('status')
                            <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
