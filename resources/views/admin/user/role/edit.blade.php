...
@section('head-tag')
    <title>مدیریت کاربران | ویرایش نقش</title>
@endsection
...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row border-1 pb-2 pt-2 pr-1 pl-1 mr-2 d-flex align-items-center"
                ...
                <strong class="text-muted mr-1 ml-1">
                    <small>
                        شما در حال ویرایش اطلاعات نقش با عنوان <span
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.user.role.update',$role->id) }}"
                  method="post"
                  id="form">
                @csrf
                @method('PUT')
                    ...
                    <section class="col-12 col-md-6 mb-4">
                        <div class="form-group">
                            ...
                            <select name="status"
                                ...
                                <option value="0" @if(!old('status',$role->status)) selected @endif>غیر فعال</option>
                            </select>
                        </div>
                        @error('status')
                        <span class="text-sm custom-alert p-2 mb-4 rounded" role="alert">
