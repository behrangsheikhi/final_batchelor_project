    ...
    <section class="sidebar-nav-sub-item">
        ...
        @foreach($categories as $category)
            <span class="sidebar-nav-sub-item-title">
                <a href="{{ route('home.products',['search' => request()->search,'sort' => request()->sort,'min_price' => request()->min_price,'max_price' => request()->max_price,'brands' => request()->brands,'category' => $category->slug]) }}"
                   class="d-inline">
                    {{ $category->name }}
                </a>
