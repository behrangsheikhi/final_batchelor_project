@extends('app.vendor.dashboard.layout.master')
            ...
            <div class="right-title w-170">
				<span class="subheader_daterange font-weight-600" id="dashboard_daterangepicker">
					<span class="subheader_daterange-label">
						...
						<span class="subheader_daterange-date text-primary">Oct 20</span>
					</span>
        ...
        <div class="row">
            <div class="col-xl-3 col-md-6 col-12">
                <div class="box box-body">
                    ...
                    <div class="font-size-12"><i class="ion-arrow-graph-up-right text-success mr-1"></i> %18 decrease
                        from last month
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <div class="box box-body">
                    ...
                    <div class="font-size-12"><i class="ion-arrow-graph-up-right text-success mr-1"></i> 324 more than
                        last year
                    </div>
                </div>
            </div>
